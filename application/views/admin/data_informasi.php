    ...
    <div class="main-content-inner">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">halaman pengolahan data Informasi</li>
            </ul>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="alert alert-block alert-info">
                        <h3 class="header smaller lighter blue">Data Informasi</h3>
                        <h4 class="pink">
                                    ...
                                    <?php foreach ($menu as $m) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url() ?>Admin/delete_informasi/<?php echo $m['id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>hapus</a>
                ...
                <div id="modal-form" class="modal" tabindex="-1">
                    <form method="post" action="<?php echo base_url('admin/informasi'); ?>" enctype="multipart/form-data">
